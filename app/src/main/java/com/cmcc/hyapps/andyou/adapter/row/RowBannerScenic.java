...
public class RowBannerScenic {
    public static View getView(Context context, final BannerSlide bannerSilde, View convertView,
        ...
        if (bannerSilde == null) {
            holder.imageView.setImageResource(R.mipmap.bg_banner_hint);
        } else {
...
//                        .getImageLoader());
                ImageUtil.DisplayImage(bannerSilde.image, holder.imageView, R.mipmap.bg_banner_hint, R.mipmap.bg_banner_hint);
