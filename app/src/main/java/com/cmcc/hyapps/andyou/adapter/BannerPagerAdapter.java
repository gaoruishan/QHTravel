...
public class BannerPagerAdapter<T> extends RecyclingPagerAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup container) {
        ...
        switch (mScene) {
            ...
            case HOME:
                view = RowBannerHome.getView(mContext, (HomeBanner) bannerSilde, convertView,
                        container,
                        (IActionCallback<HomeBanner>) mIActionCallback);
                break;

            case MARKET:
                view = RowBannerMarket.getView(mContext, (HomeBanner) bannerSilde, convertView,
                        container,
                        (IActionCallback<HomeBanner>) mIActionCallback);
                break;
            default:
