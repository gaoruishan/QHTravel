...
public class Scenic implements Parcelable {
    ...
    public Scenic(Parcel in) {
        ...
        in.readList(scenic_video,Scenic.class.getClassLoader());
        in.readList(nearby_scenic,Scenic.class.getClassLoader());
        in.readList(nearby_shop,Scenic.class.getClassLoader());
        in.readList(photos,Scenic.class.getClassLoader());
        in.readList(tag,Scenic.class.getClassLoader());
    }
    ...
    public class ScenicList extends ResultList<Scenic> {
    ...
    public static final Parcelable.Creator<Scenic> CREATOR = new Parcelable.Creator<Scenic>() {
        public Scenic createFromParcel(Parcel source) {
            return new Scenic(source);
        }
